package com.anselmo.ecommerce.catalog.order.service;

import com.anselmo.ecommerce.catalog.exception.BusinessValidationException;
import com.anselmo.ecommerce.catalog.order.domain.Order;
import com.anselmo.ecommerce.catalog.order.domain.OrderStatus;
import com.anselmo.ecommerce.catalog.order.dto.OrderItemResponse;
import com.anselmo.ecommerce.catalog.order.dto.OrderResponse;
import com.anselmo.ecommerce.catalog.order.dto.UpdateOrderStatusRequest;
import com.anselmo.ecommerce.catalog.order.exception.OrderNotFoundException;
import com.anselmo.ecommerce.catalog.order.mapper.OrderMapper;
import com.anselmo.ecommerce.catalog.order.repository.OrderRepository;
